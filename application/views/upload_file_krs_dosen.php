...
<div class="row-fluid">
        ...
        <div class="span12">
            <!-- Forms: Top Bar -->
            <div class="top-bar">
                <h3><i class="icon-cog"></i>Upload File KRS DOSEN</h3>
            </div>
              <?php if ($aktif != "") { ?>
            ...
            <div class="well">
                ...
                <blockquote style="padding:20px 10px 20px 10px; color:#333; margin:30px 30px 30px 30px;" >
                    <p>Silahkan upload file krs dosen, file yang digunakan harus sesuai dengan format yang sudah diberikan</p>
                </blockquote>
             <?php echo form_open_multipart('admin/proses_upload_krs_dosen');?>
