...
<div class="row-fluid">
        ...
        <div class="span12">
            <!-- Forms: Top Bar -->
            <div class="top-bar">
                <h3><i class="icon-cog"></i>Upload File Mata Kuliah</h3>
            </div>    
            <div class="well">
                <div class="pull-right" style="margin:30px 30px 30px 30px;">
                    <p><h4>[MATA KULIAH]</h4></p> 
                </div>
                <blockquote style="padding:20px 10px 20px 10px; color:#333; margin:30px 30px 30px 30px;" >
                    <p>Silahkan upload file data mata kuliah, file yang digunakan harus sesuai dengan format yang sudah diberikan</p>
                </blockquote>
             <?php echo form_open_multipart('admin/proses_upload_matkul');?>
