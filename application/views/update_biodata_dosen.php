<div class="container">
            ...
            <div class="well">
                ...
                <form name="myForm" action="<?php echo site_url('admin/update_proses_dosen'); ?>"  method="post">     
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span4 m-wrap" name="nip" id="nip" value="<?php echo $data_dosen->nip;?>"onKeyUp="return checkInput(this)" disabled>
                                  <input type="hidden"  name="nip1" id="nip1" value="<?php echo $data_dosen->nip;?>"onKeyUp="return checkInput(this)" >           
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span5 m-wrap" name="nama" id="nama"  value="<?php echo $data_dosen->nama;?>">
                            <span class="help-inline"> </span>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php if($data_dosen->jenis_kelamin == 1){?>
                            <label class="radio"><span><input type="radio" name="jk" id="jk" value="1" checked="true"></span> Laki - Laki</label>
 ...
 <?php }else{?>
                            ...
                            <label class="radio"><span><input type="radio" name="jk" id="jk" value="2" checked="true" ></span> Perempuan</label>                                 
                            <?php }?>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="a" class="span2" name="tanggal"id="tanggal" value="<?php echo $data_dosen->tanggal_lahir;?>"/>
                            <span class="help-inline"></span>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span3 m-wrap" name="tempat" id="tempat" value="<?php echo $data_dosen->tempat_lahir;?>">
                            <span class="help-inline"> </span>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea class="span5 m-wrap" rows="3" name="alamat" id="alamat" value=""><?php echo $data_dosen->alamat;?></textarea>
                            <span class="help-inline"> </span>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span3 m-wrap" name="jabatan" id="jabatan" value="<?php echo $data_dosen->jabatan;?>">
                            <span class="help-inline"> </span>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span3 m-wrap" name="telp" value="<?php echo $data_dosen->no_telp;?>" onKeyUp="return checkInput(this)" id="telp">
                            <span class="help-inline"></span>
                        </div>
                    </div>
