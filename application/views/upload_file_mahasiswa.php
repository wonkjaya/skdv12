...
<div class="row-fluid">
        ...
        <div class="span12">
            <!-- Forms: Top Bar -->
            <div class="top-bar">
                <h3><i class="icon-cog"></i>Upload File DATA Mahasiswa</h3>
            </div>                
            <div class="well">
                <div class="pull-right" style="margin:30px 30px 30px 30px;">
                    <p><h4>[DATA MAHASISWA]</h4></p> 
                </div>
                <blockquote style="padding:20px 10px 20px 10px; color:#333; margin:30px 30px 30px 30px;" >
                    <p>Silahkan upload data  mahasiswa, file yang digunakan harus sesuai dengan format yang sudah diberikan</p>
                </blockquote>
             <?php echo form_open_multipart('admin/proses_upload_mahasiswa');?>
