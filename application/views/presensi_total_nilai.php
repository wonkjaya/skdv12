<div class="container">
    <div class="row-fluid">
        ...
        <div class="span12">
            <!-- Forms: Top Bar -->
            <div class="top-bar">
                <h3><i class="icon-cog"></i> Hasil Nilai Mahasiswa</h3>
            </div>
            <?php if ($aktif != "") { ?>
                ...
                <?php } else { ?>     
                    ...
                    <div class="well padding">
                        ...
                        <blockquote style="padding:20px 10px 20px 10px; color:#333; margin:30px 30px 30px 30px;" >
                            <p>Menu ini berisi capaian hasil nilai yang diperoleh oleh Mahasiswa.</p>
                            <small>Pengelolaan Nilai Mahasiswa</small>
                        </blockquote>
                    ...
                    <tbody>
                        ...
                        foreach ($krs_dosen as $row):
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td  class="align-center"><a href="tampil_data_simultan/?matkul=<?php echo $row->kd_matkul;?>&kelas=<?php echo $row->kd_kls; ?>" class="icon-edit-sign" title="Detail Data"></a></td>           
                            </tr>
                            <?php
                            $no++;
                        endforeach;
